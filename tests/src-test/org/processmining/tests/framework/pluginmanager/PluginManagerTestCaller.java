...
public class PluginManagerTestCaller {
	...
	public static String test_Invoke_Other_Plugin_1(PluginContext context) throws Throwable {
		...
		Integer output = context.tryToFindOrConstructFirstNamedObject(Integer.class,
				"Test Plugin (called by PluginManagerTests - test_invoke_other_plugins)", null, null, input);
	...
	public static String test_Invoke_Other_Plugin_2(PluginContext context) throws Throwable {
		...
		PluginDescriptor plugin2 = context.getPluginManager().getPlugin(
				"org.processmining.tests.framework.pluginmanager.PluginManagerTestCallee");
		List<PluginParameterBinding> plugin2Bindings = PluginParameterBinding.Factory.tryToBind(
				context.getPluginManager(), plugin2, 0, true, true, Integer.class);
