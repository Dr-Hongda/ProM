 ...
 * @author dfahland
 */
@Plugin(name = "Test Plugin (called by PluginManagerTests - test_invoke_other_plugins)", parameterLabels = { "Input1",
"Input2" }, returnLabels = { "Output1", "Output2", "Output3", "Output4" }, returnTypes = { Integer.class,
		String.class, Double.class, Character.class }, userAccessible = true, help = "some help text")
@Ignore
// no JUnit test
