 ...
 * {@link PromTestFramework}. Call {@link #toString()} for a formatted test
 * report.
 *
 * @author dfahland
 */
public class PromTestException extends Exception {
	...
	/**
	 * Associates a test case to a thrown exception that occurred during its
	 * execution.
	 */
	...
	/**
	 * Associates a test case to expected and returned results in case the test
	 * was not successful.
	 */
	...
	private final List<ResultMismatch> failures;
	private final List<WrappedException> errors;
