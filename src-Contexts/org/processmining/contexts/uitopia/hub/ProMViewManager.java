...
public class ProMViewManager extends UpdateSignaller implements ViewManager {
	...
	public void registerResourceType(final ResourceType type) {
		...
		Set<Pair<Integer, PluginParameterBinding>> cancellableVisualizers = context.getPluginManager().find(
				Visualizer.class, JComponent.class, UIPluginContext.class, true, false, true, type.getTypeClass(),
				ProMCanceller.class);
