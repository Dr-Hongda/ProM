...
public class HtmlPanel extends javax.swing.JPanel implements HyperlinkListener {
	...
	level = PluginLevel.PeerReviewed, parameterLabels = { "HTML text" }, //
	...
	private void initComponents(String diagnosis) {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(
				...
				.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 641, Short.MAX_VALUE).addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap()
				.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 3860, Short.MAX_VALUE).addContainerGap()));
	}// </editor-fold>
