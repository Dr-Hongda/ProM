/****************************************************************************
 * Copyright (c) 2011. All rights reserved. Ted Young. Original source code
 * published at http://tedyoung.me/2011/01/22/junit-runtime-tests-overview/
 *
 ...
 * with JUnit, all methods of the test suite that are annotated with
 * {@link TestFactory} will be executed before all other tests. Each of these
 * methods dynamically adds a number of JUnit tests to the test suite.
 *
 * @author Ted Young
 */
public class FactoryRunner extends BlockJUnit4ClassRunner {
	 ...
	 * <code>validateInstanceMethods(...)</code> of
	 * {@link BlockJUnit4ClassRunner} to avoid a crash of the JUnit test suite
	 * caused by adding {@link FactoryTest}s to the test suite before
	 * pre-defined tests are loaded.
	 *
	 * The original method is marked <code>@Deprecated</code>. TODO: Remove this
	 * overriding method once the original is removed from the JUnit framework.
	 */
	@Override
