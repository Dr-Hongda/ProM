...
/**
 * Encapsulate a method (annotated with {@link TestMethod}) in a JUnit test.
 *
 * @author Dirk Fahland
 */
public class InclassMethodTest {
	...
	private final String testFileRoot;
	...
	/**
	 * @param m
	 * @return qualified Java name pointing to the location of the test in the
	 *         Java class
	 */
