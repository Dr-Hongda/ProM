...
public class AllInclassMethodTests {
	 ...
	 * @param method
	 * @return <code>true</code> iff the method is annotated with
	 *         <code>{@link TestMethod#returnSystemOut()} == true</code>. Then
	 *         the return result of the method will be everything the method
	 *         wrote to {@link System#out}.
	 */
	public static boolean testResultFromSystemOut(Method method) {
		assert (method.isAnnotationPresent(TestMethod.class));
		return method.getAnnotation(TestMethod.class).returnSystemOut() == true;
	}
