...
public class PluginDescriptorImpl extends AbstractPluginDescriptor {
	...
	private final PluginCategory[] categories;
	private final PluginQuality quality;
	private final PluginLevel level;
	...
	public String[] getCategories() {
		...
		for (int i = 0; i < categories.length; i++) {
			categoryLabels[i] = categories[i].getName();//.getName();
		}
