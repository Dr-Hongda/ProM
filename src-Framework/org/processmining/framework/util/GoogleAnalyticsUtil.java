...
public class GoogleAnalyticsUtil {
	...
	private final GoogleAnalytics ga = new GoogleAnalytics("UA-1999775-1"); // www.win.tue.nl/~hverbeek
	...
	public void runPluginEvent(String pluginName, String packageName) {
		...
		ga.postAsync(eh);
		/*
		 * if you uncomment the next line, make sure you're using post() and not
		 * postAsync() in the previous lines. Both post() and postAsync() may
		 * change the content of variable eh, which may cause problesm when
		 * writing out the value of this variable.
		 */
