...
public abstract class AbstractShape implements Shape {
	...
	protected Point2D intersection(Point2D a1, Point2D a2, Point2D b1, Point2D b2) {
		...
		double ua_t = ((b2.getX() - b1.getX()) * (a1.getY() - b1.getY()))
				- ((b2.getY() - b1.getY()) * (a1.getX() - b1.getX()));
		double ub_t = ((a2.getX() - a1.getX()) * (a1.getY() - b1.getY()))
				- ((a2.getY() - a1.getY()) * (a1.getX() - b1.getX()));
		double u_b = ((b2.getY() - b1.getY()) * (a2.getX() - a1.getX()))
		...
		if (u_b != 0) {
			...
			if ((0 <= ua) && (ua <= 1) && (0 <= ub) && (ub <= 1)) {
				return new Point2D.Double(a1.getX() + (ua * (a2.getX() - a1.getX())), a1.getY()
						+ (ua * (a2.getY() - a1.getY())));
			}
		}
		return null;
